      ...
      <div className={style.AdvanceJobSearch_main}>
        ...
        <div className={style.AdvanceJobSearch}>
          <div className={style.FormStyle_left}>
            <form className={style.formDiv} >
              <Box className={style.fromKeyword} display="flex">
                ...
                <input className={style.okInput} type="text" placeholder="Keyword" />
              </Box>
              <div className={style.ExpericenceAndLocation_Input}>
                <Box className={style.exInput} display="flex">
                  ...
                  <input className={style.okInput} type="text" placeholder="Experience" />
                </Box>
                <Box display="flex" className={style.exInput_location}>
                  <GrLocation className={style.inputIcons} />
                  <input className={style.okInput} type="text" placeholder="Location" />
                </Box>
              </div>
              <div className={style.fromKeyword}>
                <input className={style.okInput} type="text" placeholder="Industry" />
              </div>
              <div className={style.fromKeyword}>
                <input className={style.okInput} type="text" placeholder="Function" />
              </div>
              <div className={style.fromKeyword}>
                <input className={style.okInput} type="text" placeholder="Role" />
              </div>
              <div className={style.ExpericenceAndLocation_Input}>
          ...
          <div className={style.FromStyle_Right}>
            <div>
              <img
                src="https://tpc.googlesyndication.com/simgad/14167931370119027316"
                width="350"
                height="250"
            ...
            <div className={style.FromStyle_Right_Bottom}>
              ...
              <div className={style.FromStyle_Right_Bottom_bottom}>
                ...
                <div className={style.searchTips_Right}>
                  ...
                  <div>
                    <p className={style.Looking_font}>
                      Looking for an keyword search?
                    </p>
                    <p className={style.Looking_font}>
                      Put dobule quotes around the "Keyword" to search for exact
                      word/phrases.
                    </p>
                  </div>
                </div>
